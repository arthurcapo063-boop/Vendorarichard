...
- **Processing fee pass-through** — the Admin Panel can show a **"Payment processing comes with a charge of 3%"** notice and toggle whether that charge is added to the customer's checkout total. On = an extra 3% (configurable) is added at checkout; off = you absorb it.
